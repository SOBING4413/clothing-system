...
--[[
    ...
    - How to use exports:
    exports["exter-interaction"]:showInteraction('KEY', 'TEXT')

    - Also, u can make an export, without the key like this:
    exports["exter-interaction"]:showInteraction('', 'TEXT')

    - or

    exports["exter-interaction"]:showInteraction(nil, 'TEXT')

    - Hiding interaction:
    exports["exter-interaction"]:hideInteraction()
