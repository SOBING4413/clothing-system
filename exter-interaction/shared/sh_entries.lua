...
Shared.Entries[#Shared.Entries + 1] = {
    ...
    key = "key",
    type = "server",
    event = "exter-clothing:listCharacterOutfits",
    parameters = { },
}
...
Shared.Entries[#Shared.Entries + 1] = {
    ...
    text = "npc_talk",
    type = "client",
    event = "Sobing-chopshop/talkToRoman",
    parameters = { },
}
...
Shared.Entries[#Shared.Entries + 1] = {
    ...
    type = "client",
    event = "Sobing-vehicles:viewImpoundRecords",
    parameters = { },
}