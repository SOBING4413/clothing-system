...
RegisterCommand("barber" , function ()
    TriggerEvent('exter-clothing:openBarber', false)
end)

-- // EVENTS //

RegisterNetEvent('qb-clothing:client:openMenu', function()
    TriggerEvent('exter-clothing:openClothing', true)
end)


RegisterNetEvent('qb-clothing:client:openOutfitMenu', function()
    TriggerEvent('exter-clothing:outfits', true)
end)

RegisterNetEvent('qb-clothing:client:openBarberMenu', function()
    TriggerEvent('exter-clothing:openBarber', false) -- false = not free , true = free
end)